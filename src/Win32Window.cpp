...
Win32Window::Win32Window(HINSTANCE hInstance, int nCmdShow,
  ...
  m_hwnd = CreateWindowExW(
      0, L"D3D12PracticeWindowClass", m_windowTitle.c_str(),
...
Win32Window::~Win32Window() { DestroyWindow(m_hwnd); }
...
LRESULT Win32Window::OnMessage(HWND hwnd, UINT uMsg, WPARAM wParam,
                               LPARAM lParam) {
  // Forward to ImGui
